...
Контракт API: [`api/openapi.yaml`](../api/openapi.yaml) (сейчас **v1.4.0**), `GET /api/v1/openapi.yaml`, UI `/docs`. Подробнее: [l2-model-integration.md](l2-model-integration.md), [external-client-api.md](external-client-api.md).

...
| PUT | `/api/v1/tags/{id}/value` | OPC Write; optional `?verify=true` / body `verify`; requires write gate + `writable` (+ token if set) — [docs/opc-write-mode.md](../../docs/opc-write-mode.md) |
